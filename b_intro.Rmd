...
The second perspective, coming from international relations, identifies group conflict as a bargaining problem [@fearon1995rationalist; @fearon1994ethnic; @powell2006war].  Two groups want some resource -- land, power, etc -- and must decide how to distribute that resource.  Violent conflict occurs when one or both sides expect their utility from fighting to be higher than their utility from bargaining.  This perspective emphasizes two factors: (1) the range of mutually acceptable bargaining outcomes (i.e. the number of bargained outcomes preferable to fighting) [@colgan2015revolution; @lake2003international] and (2) trust that the other side will honor bargained agreements [@reed2016bargaining; @powell2006war; @kydd2000trust].  This perspective points to third party mediation [@kydd2006when; @doyle2000international; @fearon1998commitment] and *costly signals of trustworthiness/reputations for trustworthiness* [@kydd2000trust; @rohner2013war] to reduce violent conflict.
...
The psychological perspective and the international relations perspective each make valuable contributions to the study of group conflict.  The IR perspective provides a model that elucides the fundamental causes of group conflict: few agreements acceptable to both sides and low trust that the other side will honor those agreements.  It is portable, clear, and provides a basis to think about the way in which other factors affect group conflict.  The psychological perspective provides details about those other factors: emotions and group biases.  Emotions provide non-material costs to peace that limit the number of mutually acceptable bargained agreements and groups biases prevent costly signals of trustworthiness from being perceived as such by the other side.
...
the non-material costs/benefits of conflict that could sabotage agreements acceptable from a purely material standpoing; it also provides the myriad factors that affect trust and the perception of behaviors that signal trust.


Theory paragraph: non-material costs and benefits from psych; biased interpretations from psych.
