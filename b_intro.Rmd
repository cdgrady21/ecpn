...
Active conflict and economic competition could prevent contact's positive effects, and may even cause contact to increase prejudice.  Active conflict and economic competition give group members a material motivation for prejudice and hate.  In an active conflict, the groups have materially damaged each other.  In economic competition, one group's gain is the other group's loss.  Both situations are common in conflicts worldwide, but scholars have yet to grapple with how these conditions affect intergroup contact or test intergroup contact in these contexts.  

Contact theory suggests that contact should work in these contexts, provided the contact itself is conducted under proper conditions.  If the contact allow group members to (i) cooperate towards (ii) common goals in an (iii) equal status context with the (iv) support of authorities, contact should reduce prejudice.  Even when the groups are currently in conflict and competition, contact should provide experiences that reduce stereotypes [@allport1954prejudice; @gaertner2014reducing], reduce anxiety and uncertainty [@lee2001mere; @page2008little; @paolini2004effects], and increase empathy [@pettigrew2008does; @broockman2016durably] towards the outgroup.  

But will contact effectively reduce prejudice when the wider social context promotes prejudice?  Other perspectives on intergroup prejudice -- realistic group conflict theory and rational choice perspectives of conflict and psychological theories of motivated reasoning and cognitive dissonance -- would predict no effect from contact.  Intergroup contact does not change the underlying causes of the conflict; it does not affect the reason the groups have prejudice -- both the main cause (economic conflict) and the resultant violence that feeds prejudice.  The contact does not change the previous experiences the group members have, so they may interpret future interactions negatively (motivated reasoning).  Even if they have positive experiences, the cognitive dissonance generated from that positive experience cause a backlash effect that increases prejudice @gubler2011diss
...
This results of this field experiment demonstrate that intergroup contact can effectively reduce prejudice even in contexts of escalating intergroup violence and even when the groups' economic incentives oppose cooperation.  Communities that received the ECPN program increased their intergroup contact, trust in the outgroup, and perceptions of physical security, compared to the control group that received no program.  We observe the most positive changes from individuals directly involved in the intergroup committees, but most effects of intergroup contact diffuse to group members who are not involved in the intergroup contact intervention.  

This article begins by discussing the theory of intergroup contact, highlighting conditions under which contact may be less effective at reducing, or even increasing, intergroup prejudice.  We then 
