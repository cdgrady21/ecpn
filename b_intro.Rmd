...
There exists two main perspectives about group conflict.  One perspective, coming from psychology, identifies group conflict as a problem of emotion/affect and group identity.  This perspective emphasizes things like perceived threat [@riek2006threat; @stephan2011threat], anger and aggression [@Claassen2014group; @deWall2011aggression; @halperin2011emotional; @schaller2008intergroup], ethnic or religious hatred [@staub2001ethnopolitical; @cikara2014their; @Petersen2002understanding], and dehumanization [@haslam2014dehumanization; @kteily2016they] as the drivers of group violence.  This perspective points to intergroup contact [@Allport1954; @Scacco2018; @Paluck2009), perspective-taking [@Simonovits2018], and expert appeals [@Chang2018] to reduce violent conflict.
...
The second perspective, coming from international relations, identifies group conflict as a bargaining problem [@fearon1995rationalist; @fearon1994ethnic; @powell2006war].  Two groups want some resource -- land, power, etc -- and must decide how to distribute that resource.  Violent conflict occurs when one or both sides decide their expected utility from fighting is higher than their expected utility from bargaining.  This perspective emphasizes two factors: (1) the range of mutually acceptable bargaining outcomes (i.e. the number of bargained outcomes preferable to fighting; the costs and benefits of conflict versus peace) [@colgan2015revolution; @lake2003international] and (2) trust that the other side will honor bargained agreements [@reed2016bargaining; @powell2006war; @kydd2000trust].  This perspective points to third party mediation [@kydd2006when; @doyle2000international; @fearon1998commitment] and costly signaling of trustworthiness [@kydd2000trust; @rohner2013war] to reduce violent conflict.

<!--Merging IR with psych: Model from IR that structures basic problem; portable and clear.  (1) Trust and (2) benefits/costs of fighting or not fighting.  Other factors only relevant insofar as they affect these two fundamental characteristics of the problem.  From psych, the factors that affect trust and perception of behaviors that signal trust; the non-material costs and benefits that change the bargaining range: . -->

The psychological perspective and the international relations perspective each make valuable contributions to the study of group conflict.  The IR perspectives provides a model that structures the basic problem of group conflict; it is portable and clear.  Group conflict occurs when bargaining fails, bargaining fails when there is no agreement acceptable to both sides or when neither side trusts the other to honor agreements.  The psychological perspectives provides the non-material costs/benefits of conflict that could sabotage agreements acceptable from a purely material standpoing; it also provides the myriad factors that affect trust and the perception of behaviors that signal trust.

IR provides a model that formalizes the situation that causes conflict: .  Psych tells us the factors that affect the situation.

IR provides a model that explicates the characteristics that affect the situation: bargaining space (a deal is possible) and trust (they will honor the deal).  Psych tells us the details of those characteristics: deriving esteem from group superiority reduces the bargaining space, perceptual biases affect behavior that signals trust.

IR tells us this is a bargaining situation.  Psych tells us what makes that bargaining more/less difficult.

The psychological perspective and the international relations perspective each make valuable contributions to the study of group conflict.  The IR perspectives provides a model that structures the basic problem of group conflict; it is portable and clear.  Group conflict is a bargaining situation and violence occurs when bargaining fails.  bargaining fails when there is no agreement acceptable to both sides or when neither side trusts the other to honor agreements.  The psychological perspectives provides the non-material costs/benefits of conflict that could sabotage agreements acceptable from a purely material standpoing; it also provides the myriad factors that affect trust and the perception of behaviors that signal trust.


Two psych-oriented theories similar to formal theory of conflict.  (1) Realistic group conflict theory from Campbell 1965: group conflict because groups compete for resources and have "incompatible goals" (p.287).  (2) Nisbett and Cohen 1996 about a reputation for toughness.
