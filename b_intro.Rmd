...
Decades of research demonstrate that intergroup contact _can_ reduce group-level prejudice in a variety of contexts.  Intergroup contact reduces prejudice from Whites to Blacks (), Christians to Muslims, women, gays, etc [chris: from Pettigrew and Paluck studies mostly].  But few, if any, studies involve groups in active conflict or where economic imperatives drive conflict.  <!--And contact's effects on racial/ethnic groups are notably weaker than for other groups [Chris: Paluck].-->
