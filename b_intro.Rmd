...
Does intergroup contact reduce prejudice and conflict in contexts of intergroup violence?  Direct intergroup contact interventions are often applied to reduce real-world conflict between groups.  These group conflicts are defined by active violence and resource competition.  Despite a plethora of research about intergroup contact and widespread use of intergroup contact in violent contexts, we have almost no evidence about the effects of intergroup contact in violent contexts or where economic imperatives push groups apart.^[ScaccoNote]  Can intergroup contact overcome prejudice when the groups are engaged in active conflict over resources?
...
Decades of research demonstrate that intergroup contact _can_ reduce group-level prejudice in a variety of contexts.  Intergroup contact reduces prejudice from Whites towards Blacks, [@katz1978race; @marmaros2006friendships; @burns2015interaction], from Hindus towards Muslims [@barnhardt2009near], between Jews towards Arabs [@yablon2012we], from men towards women [@finseraas2016women], towards people with physical disabilities [@krahe2006disabled], towards gay people [@grutzeck1997effects], towards immigrants [@finseraas2017does], and other groups [see @paluck and @pettigrew for reviews].  None of these studies, however, involve groups in active conflict or groups competing for resources.  Few of these studies involve adults.

Active conflict and economic competition could prevent contact's positive effects, and even cause contact to increase prejudice.  Group members have material reasons to dislike each other, both because the groups desire the use of the same resources and because the groups have materially damaged each other.  Some studies also show that contact among these group members can increase prejudice [Chris: Ryan Enos, Gubler, negative contact guy].  Can direct intergroup contact overcome conflict and economic factors to reduce prejudice in places most in need of prejudice reduction?

Contact theory says yes.  Allow group members to cooperate towards common goals in an equal status context and with support of authorities.  Even when the groups are currently in conflict and competition, peace is more lucrative.  Other perspectives on intergroup prejudice -- realistic group conflict theory and rational choice perspectives of conflict -- would predict no effect from contact.  Intergroup contact does not change the underlying causes of the conflict: 
