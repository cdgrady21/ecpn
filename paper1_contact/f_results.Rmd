...
- Individual-Level caveat: not randomly assigned or selected
    - (1): they at baseline look like the random selection at baseline.  Looks like we randomly sampled from baseline respondents.
    - (2): Participants and nonparticipants look similar to each other at baseline.  Participants were not randomly assigned, but look randomly assigned.

- Main Outcomes:
    - Attitudes/Affect Towards Outgroup
        - Social Distance
        - Trust
        - Affect: List exp, endorsement experiment.
    
    - Awareness/Self-report of violent events + perceived security

    - Willingness to interact: Contact questions, Percent experiment, interaction in markets and social events


- Mechanisms:
    - Threat/anxiety
    - Empathy (helping other group in trouble) & Perspective-taking (who is responsible for violence)
    - Ingroup expansion: Social cohesion1 + "x_values", public goods game coordination
    
    - Bargaining: Index; Fewer shared resources; fewer disputes & more dispute resolution when shared.
    - Perceived Benefit: benefit_econ: "You currently benefit economically from cooperating with members of [X GROUP]" **chris: wish we had this question with "your community" also.**
    - Actual Material Benefit: endline only questions about benefitting
...
Less sharing of farmland and pastureland could imply bargaining.

- Mediators: 
    - any mechanism with support --> trust/social distance.
...
- Extended contact
    - effects on individuals not part of the progam
    - effects more on nonparticipants who knew participants?
...
**Decrease**: Cooperation in PGG, List Exp, share resources (none sig).
