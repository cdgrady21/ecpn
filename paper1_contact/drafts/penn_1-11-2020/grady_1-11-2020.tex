...
through cooperative contact allows groups to identify their latent
shared interests. By obscuring shared interests and reinforcing group
differences, violent conflict could dull, prevent, or even reverse the
predicted positive effects of contact. Some scholars believe group
reconciliation cannot begin until conflict is resolved (Bar-Tal 2000).
...
will misrepresent groups and create imagined differences between ingroup
and outgroup members. To remove these negative stereotypes new
experiences must override them, allowing an individual to
re-conceptualize the outgroup.
...
support of institutions and authorities. Allport argued that contact
works by enhancing knowledge and overriding negative stereotypes about
the outgroup.

In addition to enhancing knowledge, subsequent scholarship has
identified three additional mechanisms through which contact reduces
prejudice. First, contact reduces the feelings of threat and anxiety
...
salient a shared identity based on the groups' similarities (Gaertner
and Dovidio 2014; Gaertner et al. 1993). These mechanisms support the
reduction of prejudice for individuals involved in the intergroup
interaction, but the positive effects of contact must diffuse to
individuals not involved in the interaction for intergroup contact to
meaningfully improve intergroup relations. This diffusion to other group
members occurs through changing social norms about cross-group
interaction (Christ et al. 2014; Paluck 2009) and through the knowledge
that other ingroup members had positive contact with outgroup members
(Wright et al. 1997).
...
have latent shared interests, and that these interests remain latent due
to psychological barriers -- negative stereotypes, feelings of outgroup
threat, a lack of empathy, and a lack of perceived similarities -- to
identifying shared interests. Cooperative contact provides an obvious
example of a shared interest in the common goal that both groups work
towards, and it removes those psychological barriers to identifying
shared interest by overriding stereotypes, reducing anxiety, presenting
the other side's perspective, and demonstrating cross-group
commonalities.

Cooperative contact also provides opportunities for indirect learning
about the outgroup, which improves attitudes even for group members who
do not engage in contact. Indirect learning about the outgroup through
knowledge of cross-group interaction and social norms shows that
cross-group interaction is safe and socially encouraged, especially if
cooperation is deemed beneficial to the ingroup (Ditlmann, Samii, and
Zeitzoff 2017; Fearon and Laitin 1996). Awareness of cross-group
cooperation also creates the expectation of future interaction with
outgroup members, and that expectation motivates individuals to see the
outgroup more positively (Klein and Kunda 1992; Van Dessel, Hughes, and
De Houwer 2019). Through indirect learning cooperative contact improves
attitudes even for ingroup members with no cross-group contact.
...
interests, highlights those conflicting interests, and creates further
...
outgroup, biasing perceptions of the other side (Ward et al. 1997). If
an individual's cross-group experience does not correspond to
pre-exiting beliefs about the outgroup, the resulting psychological
...
relations for groups in violent conflict. Cooperative contact should
improve attitudes towards the outgroup when there exists a latent shared
interest to make salient, and conflicting groups share an interest in
obtaining peace because fighting is costly (Fearon 1995). Violence can
obfuscate these shared interests latent, but contact can activate them
by providing groups with an example of a shared interest that can be
reached through cooperation and removing the psychological barriers to
identifying shared interests. Successful cross-group cooperation can
generate cooperative social norms that indirectly improve attitudes for
group members, even those who do not engage in direct contact.
