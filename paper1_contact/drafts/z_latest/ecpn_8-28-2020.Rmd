...
Despite contact's many successes, scholars have only just begun to implement and analyze contact-based interventions in conflict and post-conflict settings, to mixed results.[^paluckNote]  Some studies, like @mousa2020building and @scacco2018nigeria, find that contact interventions have no impact on attitudes but may affect some behaviors.  Others, like @weiss2019curing and @ditlmann2016can, suggest that contact can improve attitudes.

Efficacy of intergroup contact in conflict and post-conflict settings an open question.  If one of the goals of cooperative contact is to mitigate violent conflict, then contact-based interventions must be tested between participants and victims in violent conflict. <!--chris: last sentence still wrong. NEED to add our own idea and contribution here.-->
