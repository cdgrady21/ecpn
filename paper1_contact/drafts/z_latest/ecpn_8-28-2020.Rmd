...
Despite contact's many successes, scholars have only just begun to implement and analyze contact-based interventions in conflict and post-conflict settings, to mixed results.[^paluckNote]  @scacco2018nigeria's mixed-group job training intervention in Nigeria influenced giving in a dictator game but not attitudes towards the outgroup; @mousa2020building's mixed soccer league intervention in Iraq changed behaviors related to soccer but not behaviors in other contexts or attitudes towards the outgroup.  In contrast, @lowe2020types's mixed cricket league intervention in India increased cross-group friendships and cross-group trading behavior, intergroup trust, and own-group favoritism; @paler2020cross shows BLANK.  Efficacy of intergroup contact in conflict and post-conflict settings an open question.  If one of the goals of cooperative contact is to mitigate violent conflict, then contact-based interventions must be tested between participants and victims in violent conflict. <!--chris: last sentence still wrong. add chagai, ditlmann, and chang? need to shorten descriptions of studies.  NEED to add our own idea and contribution here.-->
...
## Social desirability check: attitudes about violence

To provide evidence that these survey results are due to intergroup contact and not due to social desirability bias, we analyze the effect of ECPN on attitudes about violence.  If ECPN affects attitudes about violence, then we worry that other self-reports were affected by social desirability bias.  If ECPN has no effect on attitudes about violence, then it is unlikely that other self-reports were affected by social desirability bias.  Attitudes towards violence function as a placebo outcome.
