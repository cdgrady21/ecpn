...
Figures \ref{fig:vio_comm} and \ref{fig:vio_ind} show baseline to endline changes in attitudes towards violence for the treatment and control groups.  ECPN has no effect on attitudes about violence in the community-level data ($p$=0.691) or the individual-level data ($p$=0.556).  The lack of an effect on this "placebo" outcome, plus our use of survey experiments and behavioral observation to corroborate survey self-reports, suggests that our self-report results for primary outcomes are not due to social desirability bias.  More details about the placebo analysis are available in Appendix C. <!--[note: will add table] Table 1 shows two different ways of estimating the effect and two different ways of measuring attitudes about violence. -->

## Exploring these effects: state-level differences

To understand the reason for these results, we consider an important difference: state.  Conflict dynamics differ in Benue and Nassarawa -- groups in Benue tend to express more negative attitudes about the outgroup, and Benue enacted an anti-grazing law just before our endline survey.  State-level differences in the effectiveness of the intervention tell us about the effects in more or less stable situations.  This study is not powered to detect statistical differences between changes in Nassarawa and Benue, but we can look descriptively to learn how the intervention's effects may have differed in each state.

Different challenges in Nassarawa and Benue.  Benue, which always suffered more violent conflict, enacted an anti-grazing law making it illegal for pastoralists to graze animals openly, outside of fenced in areas.  This law led to armed vigilante groups attacking pastoralists, reprisals from pastoralists, a mass exodus of pastoralists from Benue, and the mobilization of military police to stabilize the situation.  Some communities had moved out of their villages and into temporary camps to avoid the violence.  In Nassarawa, dealing with influx of pastoralists fleeing Benue.

Stuff about affect.  Figures \ref{fig:affect_nas} and \ref{fig:affect_ben} show baseline-endline changes for intergroup affect in Nassarawa and Benue, respectively.  Affect improved in treatment sites relative to control sites in both states.  In Nassarawa, affect improved modestly in both types of sites, but in Benue affect fell sharply in control sites while declining only slightly in treatment sites.
...
Stuff about contact.  Figures \ref{fig:con_nas} and \ref{fig:con_ben} show baseline-endline changes for intergroup contact in Nassarawa and Benue, respectively.  Contact in Nassarawa treatment sites increased more than control sites, and contact in Benue treatment sites decreased substantially less than control sites.  These patterns are also consistent with floor and ceiling effects, however.
