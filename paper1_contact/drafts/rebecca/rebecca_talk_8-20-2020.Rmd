...
- left Weiss citation as "medical doctors" because that's the thing being randomly assigned, and the sentence is addressing what was randomly assigned (college dorm, college roommate, school, air force group, sports team, etc).
    - "leveraging the random assignment of patients to doctors across 21 emergency medical clinics"

- not removing term "placebo outcome".  It's a term people use: https://statmodeling.stat.columbia.edu/2018/09/26/potential-big-problem-placebo-tests-econometrics-theyre-subject-difference-significant-non-significant-not-statistically-significant-issue/.  It doesn't have to be an intervention that should do nothing to outcomes of interest, it can be an outcome that should be unaffected by the intervention.  I don't know why Jake/Cara had a problem with it.
...
- *add plot for "violence placebo" and call it "social desirability check".* **Done**

- Integrate the PGG into the main outcomes.
