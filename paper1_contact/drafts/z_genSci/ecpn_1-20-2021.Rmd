...
Cooperative intergroup contact has long been posited as a means to improve individuals' attitudes towards an outgroup.  Cooperative contact is contact wherein members of two groups (1) cooperate (2) with equal status (3) to achieve shared goals (4) with support of local authorities.^[Note that _equal status_ does not mean that the groups must have the same status in society, but that the groups share equal status in the cooperative situation.]  These conditions ensure positive interactions between group members.  Contact is relatively effective at this goal, even in difficult circumstances [@mousa2020building, others].  
