...
Cooperative contact removes those psychological barriers to groups identifying their shared interests and makes shared interests salient.  Contact removes psychological barriers by providing experiences with outgroups that override stereotypes, reduce anxiety, present the other side's perspective, and demonstrate cross-group commonalities.  Without negative stereotypes and automatic emotional reactions, groups can identify shared interests if shared interests are present.  The ecpectation of working with outgroup members can even motivate individuals to see group more positively, rather than motivated individuals ot maintain negative perceptions [@klein1992motivated].  With those barriers removed, cooperative contact towards a common goal provides an obvious example of shared interest: a common goal that both groups work towards.  Cooperative contact provides a shared interest and removes the barriers to grops identifying shared interesets.

Cooperative contact can also change the motivations of group members to hold positive or negative attitudes towards outgroups, even for group members who do not engage in contact.  Ingroup members vicariously learn from observing or learning about cross-group interaction, and that knowledge signals to group members that the other side is not as bad as previously believed.  Knowledge of cross-group contact also creates the expectation of cross-group contact, and the expectation of interacting with group members motivates individuals to see group more positively [@klein1992motivated; @van2019actions].  Group members are also motivated to follow social norms, and if cross-group cooperation benefits to the ingroup, ingroup members may exert social pressure on fellow ingroup members to cooperate.  This can take the form of ingroup policing [@fearon1996explaining; @ditlmann2017addressing].  
...
## Violent conflict as a hard test for cooperative contact

<!--Key points
- hard test for reasons
    - status quo is violence; groups competing and fighting for resources & trends pushing them apart.
    - engaging in actions that dehumanize the outgroup (killing)
    - motivated reasoning & confirmation bias & social norms: each group motivated to think of other group badly (motivated reasoning, social pressure), negative events salient and confirming of existing beliefs so most likely to be remembered.  lots of direct experiences to draw from.
-->

Definition of intergroup conflict (Al Ramiah and Hewstone 2013): "Intergroup conflict involves competition for dominance between two or more groups over physical resources, values, and/or claims to status and power (Coser, 1967). Conflict can usefully be thought of as occurring along a continuum. At one end of the spectrum, conflict can manifest as prejudice, stereotyping, and discrimination and can
be subtle or take more explicit forms. At the other end of the spectrum, conflict can become both overt and violent and take the form of “ethnic cleansing” and genocide (Fisher, 1994, p. 47).

Violent conflict between opposing groups poses a hard test for contact.   because groups may have no shared interests.  Even if opportunities for cooperation to help both groups achieve goals, the barriers to cooperation may prevent contact from working.
...
Cooperation is generally beneficial.  More can be accomplished with cooperation than working alone.
