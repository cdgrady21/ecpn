---
title: "Improving Intergroup Relations Amid Group Conflict: An Intergroup Contact Field Experiment in Nigeria - Abstract"
...
Intergroup contact an important tool for improving intergroup relations, but is it effective reducing group conflict.  The method is mainly tested with groups who dislike each other but are not engaged in violence.  


Acknowledgements: Israel Okpe, Hadiza Nuhu, and Mercy Corps Nigeria team for making this project possible and doing the hard work of implementing the program.  Nuole Chen, Ekrem Baser, Alice Iannantuoni, Caglayan Baser, Charla Waeiss, Cara Wong, Jim Kuklinski, Jake Bowers, and Dave Zhao for their invaluable comments on this work.  Thank the National Science Foundation for supporting this research under Grant No. 1656871. Thank USAID for supporting the Mercy Corps intervention.  A big thank you to the communities and community members who participated in the study.

<!--

The contact hypothesis: .  Ultimate goal is to reduce group conflict.  Mainly tested in labs, mainly tested with groups or people who dislike each other but are not in active conflict.

Contact might not reduce group conflict.

Contact might not improve group relations when groups are in conflict.

WHY NOT?  I DONT KNOW.  WHY DOES IT WORK IN THE FIRST PLACE?  WHY WOULDNT THOSE MECHANISMS FUNCTION IN THE REAL WORLD.  OH WAIT NO ONE KNOWS WHY IT WORKS IN LABS OR NATURAL EXPERIMENTS.  I hate all of this.  There is no framework to point to and say "These are the things that affect whether conflict occurs or not.  Contact won't affect these things if the groups are in conflict because....[give reasons].

Contact might not work for groups in conflict
    - confirmation bias / cognitive dissonance (Gubler) / perceptual biases / reactive devaluation
    - history of violence and grievances / dehumanization / emotional benefit to causing the other side pain, emotional cost to allowing grievances to go unavenged.
    - current violence: existing/continuing grievances to blame on other side.
    - Common mechanisms
        - information/dispel stereotypes: 
        - empathy: what if other group wants to hurt you? Kertzer study
        - Anxiety reduction: 


Look at:
- Chang_Peisakhin_2018
- Mackie and Smith 2017 - Group-based emotion in group processes and intergroup relations
- Castano 2008 - On the Perils of Glorifying the In-group
- Weisel and Bohm 2015 - “Ingroup love” and “outgroup hate” in intergroup conflict between natural groups
-->
