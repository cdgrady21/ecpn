...
This can again be applied to group conflict where "cooperation" is abiding by a peace agreement and "defection" is breaking it.  In the case where both players are honorable, there is no commitment problem: both players will cooperate if the other player cooperates.  Conflict could still occur due to information problems, however.  Unless both sides know that the other will reciprocate cooperation, both sides may defect to avoid being betrayed.
