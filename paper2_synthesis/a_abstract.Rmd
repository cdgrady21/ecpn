...
Why not doing ingroup policing before?  Groups need to see that cooperation is in their group-interest before punishing ingroup members for not cooperating.  Groups in conflict have limited opportunities to interact.

CRITICAL CITE: Alexander and Christia 2011 - Context Modularity of Human Altruism: cooperation possible when groups are integrated but not segregated because sanctions only succeed in integrated places.  Similar in Robinson 2017 in BJPS.

Still stuff about psych barriers to updating attitudes.  Also add dehumanization as a cost of peace: have to give up view that outgroup is subhuman.  People not motivated to change attitudes.

**********
Ekrem: 

Both conflicting and overlapping interests => bargaining failure => active conflict => low trust => low levels of contact => prejudice => lower trust etc.  The cultural stuff prevents the sides from generating what is needed for rebuilding trust = contact, that is, ability to interact.

Given ability to interact, if building trust is beneficial for the sides to get out of the Pareto inferior outcome (that is, makes Pareto optimal outcome an equilibrium, which it does), then the sides will use the opportunity to send credible signals.
