...
Chris: re-org slightly.  Right now second section starts with "3rd parties don't always work" and then goes to "reputations don't always work" and then focuses on reputations, and then goes into other ways psych phenomena prevent peaceful resolution of conflict.  But those other psych phenomena (cost/benefit of cooperation) are not about reputation.

Sec 1: same.  info/commit problems, 3rd parties and reputations usually handle.
sec 2: biased perceptions.  why groups in conflict don't get accurate perceptions of each other, so reputations don't work.  Biased interpretation of events.  Maybe + why groups don't want to update (cog dissonance).
Sec 3: If they had accurate/unbiased perceptions, each side is unwilling to accept reasonable bargains because benefits/costs of cooperation.  Even if things set in your favor, with information/commit problems, groups cannot reach a bargain because there is no agreement that both groups will accept.

OR

Sec 1: Add a 3rd problem to information/commitment problems.  No bargaining space because psych benefist/costs of cooperation. in real world, dealing with 
Sec 2: Reputations and biased perceptions.

OR 

Sec 1: deviations from material rationality (cost/benefits of cooperation).  
Sec 2: info/commit problems; third parties and reputations, + why reputations don't work with biased perceptions.
...
Where third parties cannot effectively intervene, conflicting groups could negotiate based on reputation, but reputations are more likely to hinder than to help the bargaining of groups in conflict.  Group members tend to ascribe negative traits to outgroups [@tajfel1981groups, @brewer1999ingroupOutgroup], including immorality and dishonesty [@weisel2015ingroup; @parker2013lessons; @levine1972ethnocentrism; @eidelson2003dangerous].  Group members also dehumanize outgroup members and refrain from extending them empathy or forgiveness [@haslam2014dehumanization; @opotow1990moral; @bandura1999moral; @gutsell2010empathy; @tam2007impact].  <!--These psychological phenomena introduce significant friction in the ability of groups to build trusting reputations and significantly restrain opportunities through which trust could be built.  They also prevent peaceful resolution of conflict by increasing the costs of cooperation and benefits of defection.-->
...
Group members interpret the belligerent action of other ingroup members as defensive and justified, while they see defensive action by outgroup members as belligerent and threatening [@ward1997naive; @duncan1976differential; @vallone1985hostileMedia].  Even positive actions by outgroup members may be re-interpreted as negative to avoid cognitive dissonance [@gubler2013humanizing; @paolini2010negative].  Group members then attribute those negative outgroup behaviors to internal characteristics that define all outgroup members [@hewstone1990ultimate].  At the same time, they under-generalize positive behaviors as exceptional to the outgroup and selectively remember events that corroborate their pre-existing negative perceptions [@de2008motivated]. 

Groups in conflict are given many events to justify their negative perceptions.  Negative perceptions, and the biased interpretations they beget, make it very difficult for a group to develop a positive reputation with a group they are in conflict with, even when both groups are motivated to end the conflict.  These biases prevent accurate perceptions of the attitudes, preferences, and likely behavior of the outgroup, thereby causing information problems.  They also sap the power of each group to send costly signals of willingness to cooperate in future interactions, undermining the creation of intergroup trust and cooperative reputations to prevent commitment problems [@kydd2000trust, @rohner2013war].<!--chris: the first half fo this paragraph seems to belong elsewhere.  "belief that other side owes your side something/other side has committed transgressions whereas your side is defensive."-->

  This bias likely pushes each group's perception of the other side's willingness to make peace further from their true willingness to make peace and so reputations hinder, rather than aid, intergroup bargaining processes.
