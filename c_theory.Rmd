...
The reputation mechanism could prevent intergroup conflict but reputations, too, are hampered by animosity  <!--We tend to ascribe negative traits to outgroups and positive traits to ourselves [cite: ultimate/fundamental attribution error, tajfel1981, brewer1999; @amir1969contact; @brewer1991social].-->Animosity biases interpretations of ingroup and outgroup behavior, which makes it very difficult for a group to develop a positive reputation with a group they are in conflict with, even when both groups are motivated to end the conflict.  This bias likely pushes each group's perception of the other side's willingness to make peace further from their true willingness to make peace and so reputations hinder, rather than aid, intergroup bargaining processes.
...
Indirectly, these negative attitudes also change the each groups preference for peace or war, both for leaders and for individuals who encounter disagreements with outgroup members. <!--chris: may want to hurt the other group -->  The utility an individual gets for attitudes and behaviors depends largely on how those attitudes and behaviors are received by their ingroup [@wood2000attitude].  These "social payoffs" constrain the actions of leaders and individual group members.  In the context of outgroup animosity, the group might punish a leader for cooperating or compromising with the outgroup [@fearon1994domestic]<!--chris: domestic audience costs-->.  Individuals might get similarly socially punished for cooperating instead of taking a hard stand against the other side's perceived transgressions [@dreu2010social.  Leaders of hostile groups also cannot credibly commit to keep their group members in check.  Individuals in these groups might not engage in ingroup policing, a strong, costly signal to the other side that your group will uphold its peace agreements [@fearon1996explaining].  While cooperation and ingroup policing might be punished, aggressive actions may be seen as righteous self-defense of the ingroup and rewarded.  Groups that see the other side as immoral may receive some internal benefit from harming the outgroup [@weisel2015ingroup] 
