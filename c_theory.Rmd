...
<!--Ekrem: "there is no need to pitch contact as a substitute for intervention. Instead I am a proponent of highlighting how contact can complement our existing tools both by using it when intervention is not possible and also by using it when it is possible to make it work better."  
