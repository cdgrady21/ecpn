...
If poor relations between groups causes psychological barriers that prevent groups from bargaining successfully, then improving intergroup relations should remove those barriers and allow groups to reach peaceful agreements through bargaining.  One prominent approach to improving relations between groups comes from intergroup contact theory [@allport1954prejudice].  Intergroup contact theory hypothesizes that intergroup relations can be improved through interactions in which group members (1) cooperate (2) with equal status (3) to achieve shared goals (4) with the support of elites.  Improving relations -- especially improving trust -- can help groups overcome information and commitment problems and reduce the likelihood of violence.

Structured intergroup contact can improve intergroup relations for several reasons.  First, direct experience with members of another group can dispel stereotypes and correct misperceptions by providing information about that group [@allport1954prejudice].  <!--Groups often build elaborate myths about the evil of the other to justify their feelings of ingroup superiority.-->  For resolving conflict, the primary negative stereotype preventing peace is that the other group is untrustworthy.  The interaction provides opportunities for costly signals  

Second, decrease discomfort from anxiety/threat. Third, increase empathy.  Fourth, show that working together is positive and materially beneficial; tangible evidence that both groups are better off cooperating than fighting.  Fifth, reduce the perceived social distance between the groups and even expand the ingroup to include the former outgroup.
...
Important to differentiate structured vs unstructred contact.  Contact under other conditions -- such as incidental contact, intergroup competition, interactions in which one group has power over the other, elite disapproval of intergroup contact -- is unlikely to improve intergroup relations [@enos2014causal; @forbes1997ethnic]<!--hhabyarimana et al 2007; vanhanen 1999-->.]  This concern is heightened from groups in conflict, whose incidental interactions are likely antagonistic.
  ...
  - $\mathbf{H_1a}:$ **Intergroup contact will help.**  Specifically, increase trust, decrease animosity, increase physical security.
  - $\mathbf{H_2a-c}:$ Effect will be mediated by less social distance/more ingroup expansion; decreased threat;  perceptions of economic benefit.


Competition for resources itself causes poor intergroup relations/negative intergroup attitudes.
Therefore competition for resources will _always_ cause conflict.
Intergrop contact will do nothing because it doesn't change underlying resource competition.
Groups still engage in competition for resources, which breeds conflict [@campbell1965ethno; @Sherif1988robbersCave].
