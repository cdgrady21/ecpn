...
If psychological barriers to cooperating with outgroups prevent groups from reaching peaceful agreements, then removing those barriers should allow groups to bargain and avoid conflict.  One approach to improving relations between groups comes from intergroup contact theory [@allport1954prejudice].  Intergroup contact theory hypothesizes that intergroup relations can be improved through interactions in which group members (1) cooperate (2) with equal status (3) to achieve shared goals (4) with the support of elites.[^otherContact].  Improving relations -- especially improving trust -- can help groups overcome information and commitment problems and reduce the likelihood of violence.

Intergroup contact structured in these ways can improve intergroup relations for several reasons.  First, provide information and dispel stereotypes/myths.  The interaction provides opportunities for costly signals  Second, decrease discomfort from anxiety/threat. Third, increase empathy.  Fourth, show that working together is positive and materially beneficial; tangible evidence that both groups are better off cooperating than fighting.  Fifth, reduce the perceived social distance between the groups and even expand the ingroup to include the former outgroup.
