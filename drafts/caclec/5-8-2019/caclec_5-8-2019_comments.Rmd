...
- Ekrem: Disagrees with "To successfully bargain, the groups need (1) accurate information about each other, and (2) the assurance that each side will abide by its agreements." because some bargaining might need one but not the other.  He wants to know what it means for an international actor to have a stake in the conflict.  He likes the argument that international actors will not intervene until the dispute escalates because intervention is costly.
